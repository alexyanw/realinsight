...
function query_county_zips(county) {
  /*
  if(g_zip_stats != undefined) {
    var stats = {};
    for(i in zips) {
  ...
  */
  var req_data = {month: 12, county: county};
  $.ajax({
    url: '/statistics/query_county',
    type: 'GET',
    dataType: 'json',
    contentType: 'application/json',
    data: req_data,
